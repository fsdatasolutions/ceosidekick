          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-violet-100 flex items-center justify-center">
                <ImageIcon className="w-5 h-5 text-violet-600" aria-hidden="true" />
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-sky-100 flex items-center justify-center">
                <MessageSquare className="w-5 h-5 text-sky-600" aria-hidden="true" />
              </div>
              <div>
              ...
              return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <ArrowRight className="w-5 h-5 text-neutral-400 group-hover:text-primary-red group-hover:translate-x-1 transition-all flex-shrink-0" aria-hidden="true" />
                    </div>
                  </Link>
              );
            })}
                      ...
                      >
                        ...
                        {item.status}
                          ...
                          <p className="text-sm text-neutral-500">
                            {item.type.replace("_", " ")} &middot; Updated {formatRelativeTime(item.updatedAt)}
                          </p>
                        </div>
                        <ArrowRight className="w-5 h-5 text-neutral-400 flex-shrink-0" aria-hidden="true" />
                      </Link>
                  );
                })}
              </div>
        ...
        {contentStats.total === 0 && (
            <div className="bg-white rounded-xl border border-neutral-200 p-8 text-center">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary-red/10 to-amber-500/10 flex items-center justify-center mx-auto mb-4">
                <Sparkles className="w-8 h-8 text-primary-red" aria-hidden="true" />
              </div>
