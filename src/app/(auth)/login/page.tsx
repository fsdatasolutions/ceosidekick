    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-end">
          <Link href="/forgot-password" className="text-sm text-primary-red font-medium hover:underline">
            Forgot password?
          </Link>
        </div>
      ...
      <div className="mt-6 p-4 bg-neutral-100 rounded-xl">
        ...
        <p className="text-sm text-neutral-700 font-mono">demo@ceosidekick.biz / password123</p>
      </div>
    ...
    <div>
      ...
      <div className="lg:hidden flex justify-center mb-8">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-xl text-neutral-900">CEO Sidekick</span>
        </Link>
      </div>

      {/* Header */}
      <div className="text-center mb-8">
        <h1 className="font-display text-3xl font-bold text-neutral-900 mb-2">Welcome back</h1>
