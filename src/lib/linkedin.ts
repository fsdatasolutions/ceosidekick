...
/**
 * Build the redirect URI for LinkedIn OAuth callbacks.
 */
...
/**
 * Get the LinkedIn account row for a user from the accounts table.
 */
...
/**
 * Parse the LinkedIn profile info stored in the idToken column.
 */
